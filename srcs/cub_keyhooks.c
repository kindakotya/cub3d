...
/*   Updated: 2021/04/22 03:24:48 by gmayweat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int key_pressed(int keycode, t_all *s_all)
{
	...
	if (s_all->s_args->
		map[(int)s_all->s_args->player.y][(int)s_all->s_args->player.x] != c)
		s_all->s_args->
		map[(int)s_all->s_args->player.y][(int)s_all->s_args->player.x] = c;
	sort_keys(keycode, s_all);
	if (c != s_all->s_args->
		map[(int)s_all->s_args->player.y][(int)s_all->s_args->player.x])
		c = s_all->s_args->
		map[(int)s_all->s_args->player.y][(int)s_all->s_args->player.x];
